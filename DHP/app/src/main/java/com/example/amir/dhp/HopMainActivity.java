 ...
 */
public class HopMainActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // Initialize
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hop_activity_main);

        // Update the toolbar
        getSupportActionBar().setTitle("HOP");
        ...
        for (int i = 0; i < 10; i++) {
            if (i + level >= 10)
                crowded[i].setBackgroundColor(ContextCompat.getColor(getApplicationContext(), R.color.hopCrowd));
            else
                crowded[i].setBackgroundColor(ContextCompat.getColor(getApplicationContext(), R.color.hopCrowdEmpty));
        }
    }

    public void hopSearchMenuClicked(View view) {
        Intent i = new Intent(this, HopMenuActivity.class);
        startActivity(i);
    }

    public void hopNewMealClicked(View view) {
        Intent i = new Intent(this, HopMealActivity.class);
        startActivity(i);
    }

    public void hopLoadMealClicked(View view) {
        AlertDialog.Builder b = new AlertDialog.Builder(this);
        b.setTitle("Hop Meals");
        ...
        b.setItems(types, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(HopMainActivity.this, HopMealActivity.class);
    ...
    private void updateTime() {
        String [] msgs = Util.getHopTime();

        ((TextView) findViewById(R.id.hop_main_time_label)).setText(msgs[0]);
        ((TextView) findViewById(R.id.hop_main_time)).setText(msgs[1]);
    }
}
